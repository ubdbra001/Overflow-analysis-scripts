...
function [EEG, Irej, com] = cust_eegthresh( EEG, icacomp, elecrange, negthresh, posthresh, ...
...
if calldisp
    ...
    if icacomp == 1
        ...
        eegplot( EEG.data(elecrange,:,:), 'srate', EEG.srate, 'limits', [EEG.xmin EEG.xmax]*1000 ,'title', [EEG.setname ' - ' num2str(length(Irej)) '/' num2str(EEG.trials) ], 'command', [command(1:885) command(end-75:end)], eegplotoptions{:}); 
    else
